            ...
            <h1 className="mx-auto lg:text-center">
              <span className="font-display block text-base font-semibold text-neutral-950">
               ...
               <span className="font-display mt-6 block max-w-5xl text-balance text-5xl font-medium tracking-tight text-neutral-800 sm:text-7xl">
                Fostering a skilled and vibrant community
               </span>
            </h1>
            <p className="mt-6 max-w-3xl text-balance text-xl text-neutral-600 mx-auto lg:text-center">
              <strong>DEVSA</strong> is a educational non-profit organization for the software development and engineer community
            </p>
          </WavyBackground>
      </FadeIn>
      </Container>
