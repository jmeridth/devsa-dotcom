...
export function Slides() {
  ...
  return (
    <>
      <div className="h-screen w-full relative mt-24 sm:mt-32 lg:mt-40">
      <ImagesSlider images={images}>
        ...
        >
          ...
          >
            Our mission is to empower developers with the tools, knowledge, and connections they need to thrive.
